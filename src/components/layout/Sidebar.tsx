  ...
  return (
    <div className="w-72 bg-slate-900 text-slate-300 flex flex-col h-screen border-r border-slate-800 flex-shrink-0 sticky top-0 overflow-y-auto">
      <div className="p-6 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold text-white tracking-tight">Kulu API</h1>
          <p className="text-xs text-slate-400 font-medium tracking-wider uppercase mt-1">Developer Portal</p>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-slate-800 shrink-0">
        <div className="flex items-center justify-between px-3 py-2 group">
          <div className="flex items-center gap-3 overflow-hidden">
            <div className="w-8 h-8 flex-shrink-0 rounded-full bg-gradient-to-tr from-indigo-500 to-purple-500 flex items-center justify-center text-white font-semibold shadow-inner">
              D
            </div>
            <div className="flex flex-col min-w-0">
              <span className="text-sm font-medium text-white truncate">Developer</span>
              <span className="text-xs text-slate-400 truncate">Personal Space</span>
            </div>
          </div>
          <button 
